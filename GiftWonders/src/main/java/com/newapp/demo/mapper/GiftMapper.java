...
public class GiftMapper {
  public static GiftDTO maptoGiftDto(Gift gift) {
    return new GiftDTO(gift.getGiftid(), gift.getGiftname(), gift.getGiftDetails(), gift.getGiftPrice());
  }

  public static Gift maptoGift(GiftDTO giftto) {
    return new Gift(giftto.getGiftid(), giftto.getGiftName(), giftto.getGiftDetails(), giftto.getGiftPrice());
